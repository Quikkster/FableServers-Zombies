...
# `Azza Trickshotting ~ FableServersZombies`<br />
...
# `FableZombies: Mod Installation Guide`
## t6 - Method 1:
...
Plutonium:
add your friends on the plutonium forum by clicking the + button on the top right of the profile
they shold then appear on you in game friends list, then join them or start a party(bo2 only)
you may have to invite if your game is set to invite only
